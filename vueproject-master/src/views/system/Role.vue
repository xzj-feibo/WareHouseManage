...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%; border-color: #3a8ee6">
      ...
      <el-table-column sortable prop="roleNo" label="角色代码" width="150">
      </el-table-column>
	  <el-table-column sortable prop="createUserName" label="创建人" width="150">
	  </el-table-column>
	  ...
	  <el-table-column sortable prop="editUserName" label="修改人" width="150">
	  </el-table-column>
