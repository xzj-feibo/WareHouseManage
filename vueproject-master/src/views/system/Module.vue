  ...
  <div>
    ...
    <el-row>
      ...
      <el-col :span="6">
        ...
        <el-tree class="treeclass" ref="tree" :data="treeData" default-expand-all=""
		:props="defaultProps"  @check-change="handleClick" check-strictly node-key="id" show-checkbox></el-tree>
		<!-- :props="defaultProps" @node-click="nodeclick" @check-change="handleClick" check-strictly node-key="id" show-checkbox></el-tree> -->
      </el-col>
      <el-col :span="18">
        <div class="mod-btnbox">
...
export default {
  ...
  methods: {
    ...
    handleClick(data, checked, node) {
      if (checked) {
        this.checkVal.push(data.menuid)
