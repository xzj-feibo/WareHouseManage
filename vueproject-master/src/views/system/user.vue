...
<!--        <el-button size="small" type="primary" @click="handleunit()">部门设置</el-button> -->
    ...
    <!--列表-->
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%; border-color: #3a8ee6">
          <el-table-column align="center" type="selection" width="50" class="border">
          </el-table-column>
		  <el-table-column align="center" sortable prop="id" label="用户id" v-if="false" width="120" >
		  </el-table-column>
          <el-table-column align="center" sortable prop="deptName" label="部门" width="70" >
          </el-table-column>
		  <el-table-column align="center" sortable prop="roleName" label="角色" width="70">
		  </el-table-column>
      ...
      <el-table-column align="center" sortable prop="gender" label="性别" width="120">
		  ...
		  <el-table-column align="center" sortable prop="createUserName" label="创建人" min-width="80">
		  </el-table-column>
		  ...
		  <el-table-column align="center" sortable prop="editUserName" label="更新人" min-width="80">
		  </el-table-column>
		  <el-table-column align="center" sortable prop="editTime" label="更新时间" min-width="120">
		    <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
		...
		<el-select size="small" v-model="editForm.roleId" placeholder="请选择" class="userRole">
			<el-option v-for="parm in frole" :key="parm.id" :label="parm.roleName" :value="parm.id"></el-option>
		</el-select>
        </el-form-item>
		...
		<el-select size="small" v-model="editForm.deptId" placeholder="请选择" class="userDept">
			<el-option v-for="parm in fdept" :key="parm.id" :label="parm.deptName" :value="parm.id"></el-option>
		</el-select>
		</el-form-item>
  ...
  methods: {
	...
	getDept(){
		deptListNoParms()
		  ...
		  .catch(err => {
		    this.loading = false
		    this.$message.error('部门列表获取失败，请稍后再试！')
		  })
	},
    // 修改type
